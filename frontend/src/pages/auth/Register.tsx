...
import { ShieldCheck, Moon, Sun, User as UserIcon, GraduationCap } from 'lucide-react';
...
export const Register: React.FC = () => {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Navigate to onboarding workspace create or join
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#F5F5F5] dark:bg-[#09090B] transition-colors duration-200">
      ...
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-12 md:px-20 lg:px-32 bg-white dark:bg-[#121214] border-r border-zinc-200 dark:border-zinc-800 py-12">
        <div className="max-w-md w-full mx-auto space-y-8">
          <div>
            ...
            <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
              ...
              <Link to="/login" className="font-semibold text-accentblue dark:text-zinc-300 hover:underline">
                Sign in here
              </Link>
            </p>
          </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`flex items-center justify-center gap-2 py-3 border rounded-xl font-medium transition-all text-sm ${
                    role === 'student'
                      ? 'bg-zinc-950 dark:bg-white text-white dark:text-zinc-950 border-zinc-950 dark:border-white'
                      : 'bg-[#F5F5F5] dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400 hover:bg-zinc-100'
                  }`}
                >
      ...
      {/* Right Pane: Dark Presentation Card */}
